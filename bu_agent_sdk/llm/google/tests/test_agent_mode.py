...
class TestSerializerToolCalls:
    ...
    def test_tool_message_non_object_json_is_wrapped(self):
        """Gemini FunctionResponse requires object payloads, not arrays/scalars."""
        tool_msg = ToolMessage(
            tool_call_id="call_456",
            tool_name="list_pages_summary",
        ...
        assert fr is not None
        assert fr.name == "list_pages_summary"
        assert fr.response == {"result": [{"page_number": 1}, {"page_number": 2}]}
